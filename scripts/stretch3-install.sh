...
## execute `sh ./microbitSerial/scripts/stretch3-install.sh`
## supposed dir configuration:
##  scratch-gui
##      - microbitSerial

LF=$(printf '\\\012_')
LF=${LF%_}
EXTENSION_NAME=MicrobitSerial
EXTENSION_REP=mm-stretch3
EXTENSION_ID=microbitSerial
COLLABORATOR="Diego-Luna"
EXTENSION_DESCRIPTION="Connect and communicate with Micro:bit via Serial."
