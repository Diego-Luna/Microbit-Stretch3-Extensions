...
var en$1 = {
	"microbitSerial.entry.name": "Micro:bit Serial",
	"microbitSerial.entry.description": "Connect and communicate with Micro:bit via Serial"
};
var translations$1 = {
	en: en$1
};
...
var entry = {
  get name() {
    return formatMessage$1({
      ...
      default: translations$1.en['microbitSerial.entry.name'],
  ...
  get description() {
    return formatMessage$1({
      defaultMessage: translations$1.en['microbitSerial.entry.description'],
  ...
  helpLink: 'https://tu-url-de-ayuda/',
  // Cambia esto a la URL correcta de tu página de ayuda
...
var EXTENSION_ID = 'microbitSerial';
...
var extensionURL = 'https://github.com/Diego-Luna/Microbit-Stretch3-Extensions/dist/microbitSerial.mjs';
var port;
var writer;
...
function _connect() {
  _connect = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
    var textEncoder;
    return regenerator.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 16:
          ...
          console.error('Error al conectar:', _context.t0);
        case 19:
        case "end":
...
function _disconnect() {
  _disconnect = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          console.error('Error al desconectar:', _context2.t0);
        case 13:
        case "end":
 ...
 */
function _sendData() {
  _sendData = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(dataToSend) {
    return regenerator.wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 1;
          _context3.next = 4;
          return writer.write(dataToSend + '\n');
        case 4:
        ...
        case 7:
          ...
          console.error('Error al enviar datos:', _context3.t0);
        case 10:
          _context3.next = 13;
          break;
        case 12:
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  return _createClass(ExtensionBlocks, [{
    ...
    value: function sendData(args) {
      _sendData2(cast.toString(args.DATA));
    }
  }], [{
    key: "formatMessage",
    set:
