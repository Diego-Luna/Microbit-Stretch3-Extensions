...
const imgMenu = "data:image/svg+xml;base64,..."; // Truncated for brevity
const imgBLOC = "data:image/svg+xml;base64,..."; // Truncated for brevity
...
class MicrobitSerial {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description: 'Train model of AI with epochs'
                    }),
                    arguments: {
                        EPOCHS: {
                            type: ArgumentType.NUMBER,
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description: 'Send data to micro:bit'
                    }),
                    arguments: {
                        DATA: {
                            type: ArgumentType.STRING,
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description: 'Receive data from micro:bit'
                    })
                },
                {
                    opcode: 'predict',
    ...
    async collectDataForClass(args) {
        ...
        if (classIndex >= 0 && classIndex < classNames.length) {
            ...
            console.log(`Agregada muestra para la clase ${classNames[classIndex]}: ${dataByClass[classIndex].length}`);
        }
    }

    setTimeToken(args) {
        timeToken = args.TIME_TOKEN;
    }
    ...
    async loadModel(args) {
        const classNamesLink = args.CLASS_NAMES_LINK;
        const modelJsonLink = args.MODEL_JSON_LINK;
        const modelBinLink = args.MODEL_BIN_LINK;
        await loadModelFromLinks(classNamesLink, modelJsonLink, modelBinLink);
    }
